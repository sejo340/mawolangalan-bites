...
import { FaCake, FaWhatsapp } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-brand-cream py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <FaCake className="text-6xl text-brand-green mx-auto mb-4" />
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8">
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                required
                rows="4"
                placeholder="Describe the design, colors, theme, decorations, etc. (e.g., 'Pink and white cake with roses and gold accents for a wedding')"
          ...
          <button
            type="submit"
            className="w-full bg-green-500 text-white py-4 rounded-lg font-bold text-lg hover:bg-green-600 transition mt-8 flex items-center justify-center gap-2"
          >
